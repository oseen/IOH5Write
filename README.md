...
This branch is based on a fork from https://github.com/hakostra/IOH5Write. The library of this branch 'IOH5Write_b_OFv6' has now the possibility to include patches or boundary data to be written to hdf5 archive (beside the internalField and kinematic cloud data). It works with newer OpenFOAM versions. I was adapted for and tested with OpenFOAM-6.
